    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::group([
            ...
            Route::group([
                ...
                Route::post('/dashboard', ['uses' => $namespacePrefix . 'VoyagerMenuController@add_item',    'as' => 'add']);
                Route::put('/dashboard', ['uses' => $namespacePrefix . 'VoyagerMenuController@update_item', 'as' => 'update']);
            });
        });
        ...
        Route::group([
            ...
            Route::get('/dashboard', ['uses' => $namespacePrefix . 'VoyagerSettingsController@index',        'as' => 'index']);
            Route::post('/dashboard', ['uses' => $namespacePrefix . 'VoyagerSettingsController@store',        'as' => 'store']);
            Route::put('/dashboard', ['uses' => $namespacePrefix . 'VoyagerSettingsController@update',       'as' => 'update']);
        ...
        Route::group([
            ...
            Route::get('/dashboard', ['uses' => $namespacePrefix . 'VoyagerMediaController@index',              'as' => 'index']);
        ...
        Route::group([
            ...
            Route::get('/dashboard', ['uses' => $namespacePrefix . 'VoyagerBreadController@index',              'as' => 'index']);
            Route::get('{table}/create', ['uses' => $namespacePrefix . 'VoyagerBreadController@create',     'as' => 'create']);
            Route::post('/dashboard', ['uses' => $namespacePrefix . 'VoyagerBreadController@store',   'as' => 'store']);
        ...
        Route::group([
            ...
            Route::get('/dashboard', ['uses' => $namespacePrefix . 'VoyagerCompassController@index',  'as' => 'index']);
            Route::post('/dashboard', ['uses' => $namespacePrefix . 'VoyagerCompassController@index',  'as' => 'post']);
        });
